...
OBJS=src/asn1.o deps/auxiliar/auxiliar.o src/bio.o src/cipher.o src/cms.o src/compat.o \
     ...
     src/group.o src/hmac.o src/lbn.o src/lhash.o src/misc.o src/ocsp.o src/openssl.o  \
     src/ots.o src/pkcs12.o src/pkcs7.o src/pkey.o src/point.o src/rsa.o src/ssl.o     \
